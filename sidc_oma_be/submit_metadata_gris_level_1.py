...
DATASET = 'GRIS level 1'
TAP_SERVICE_URL = 'http://dachs.sdc.leibniz-kis.de/tap'
TABLE_NAME = 'gris.epn_core'


class DataLocation(DataLocationFromTapRecord):
	def get_file_size(self):
		# The access_estsize is not always set or worse is sometime negative
		try:
		...
		if file_size < 0:
			logging.warning('File size is negative %s, setting to 0', file_size)
			file_size = 0
