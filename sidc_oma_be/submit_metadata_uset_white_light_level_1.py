...
class DataLocation(DataLocationFromLocalFile):
	...
	BASE_FILE_PATH = '/mnt/solar1-uset/cameras/output_img/FTS/L1c/USET_White_Light/'

	# The base file URL to build the default file_url (must end with a /)
	BASE_FILE_URL = 'https://www.sidc.be/uset/data/cameras/output_img/FTS/L1c/USET_White_Light/'
	...
	BASE_THUMBNAIL_URL = 'https://www.sidc.be/uset/data/cameras/output_img/png/L1c_png_750_text/USET_White_Light/'
